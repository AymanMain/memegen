...
const MemePage: React.FC<MemePageProps> = ({ params }) => {
  ...
  useEffect(() => {
    const fetchMeme = async () => {
      try {
        const memeDoc = await getDoc(doc(db, "memes", params.id));
        if (memeDoc.exists()) {
          ...
          await updateDoc(doc(db, "memes", params.id), {
